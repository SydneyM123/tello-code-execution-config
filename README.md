...
#### For this setup guide Docker is required. ![https://docs.docker.com/engine/install/debian/](This link) contains the docs for installing Docker on a Debian (Raspbian) based system:
